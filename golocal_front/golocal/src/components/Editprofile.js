            ...
            render () {
                return (
                    <form onSubmit={this.submitInput}>
                        <Container>
                                <Name>
                                    <input placeholder="Name" value={profileFormData.name} name="name" type="text" onChange={this.userInfo} />
                                </Name>
                                <Email>
                                    <input placeholder="Email" value={profileFormData.email} name="email" type="text" onChange={this.userInfo} />
                                </Email>
                                <Username>
                                    <input placeholder="Username" value={profileFormData.username} name="username" type="text" onChange={this.userInfo} />
                                </Username>
                                <Password>
                                    <input placeholder="Password" value={profileFormData.password} name="password" type="text" onChange={this.userInfo} />
                                </Password>
                                    <Business>
